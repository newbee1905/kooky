...
import (
	...
	_ "github.com/newbee1905/kooky/browser/all" // This registers all cookiestore finders!
	// _ "github.com/newbee1905/kooky/browser/chrome" // load only the chrome cookiestore finder
)
